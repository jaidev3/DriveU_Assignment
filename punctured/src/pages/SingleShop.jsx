...
function SingleShop() {
  ...
  return (
    <Wrapper>
      ...
      <div className="body">
        <div className="img">
          <img src="https://hgtvhome.sndimg.com/content/dam/images/hgtv/fullset/2019/7/11/0/DOTY0219_Lauren-Nelson-Design_Sunset-Idea-House_1.jpg.rend.hgtvcom.966.644.suffix/1562855447397.jpeg"></img>
        </div>
